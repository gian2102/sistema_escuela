...
<body>
  ...
  <h1 class="title-modules">Ingreso de Asistencia</h1>
    ...
    <div id="feedback-form">
        ...
        <div>
            <form action="insert.php" method="POST">
                ...
                <input type="hidden" name="alumno_id" value="<?php echo $us_id; ?>">
                <input type="date" name="fecha" id="fecha" required>
                <input type="text" name="asistencia" placeholder="Asistencia" id="asistencia" required>
                <input type="text" name="observacion" placeholder="Observación" id="observacion">
