...
$sql_edit = "select * from tb_asistencia WHERE alumno_id='$id_edit'";
    ...
    <div id="main-container">
        <div class="conteiner-add">
            ...
            <form action="update.php" method="POST" id="myForm">
                ...
                <input type="hidden" name="alumno_id" value="<?php echo $row_edit['alumno_id'] ?>">
