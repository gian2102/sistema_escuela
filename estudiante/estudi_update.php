    ...
    <div id="main-container">
        <div class="conteiner-add">
            ...
            <input type="text" class="form-control mb-3" name="nombre" placeholder="nombre"
                value="<?php echo $row_edit['est_nombres'] ?>">
            <input type="text" class="form-control mb-3" name="apellido" placeholder="apellido"
                value="<?php echo $row_edit['est_apellidos'] ?>">
            <input type="text" class="form-control mb-3" name="apoderado" placeholder="apoderado"
                value="<?php echo $row_edit['est_apoderado'] ?>">
            <input type="text" class="form-control mb-3" name="telefono" placeholder="telefono"
                value="<?php echo $row_edit['est_apoderadocel'] ?>">
            <input type="date" class="form-control mb-3" name="fecha" placeholder="fecha"
                value="<?php echo $row_edit['est_fechnac'] ?>">
