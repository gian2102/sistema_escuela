...
$sql_tb = "select * from tb_curso WHERE cur_id='$id_delete'";
    ...
    <div id="main-container">
        <div class="conteiner-add">
            ...
            <form action="delete.php" method="POST">
                ...
                <input type="hidden" name="cur_id" value="<?php echo $row_delete['cur_id'] ?>">
                <input readonly type="text" class="form-control mb-3" name="nombre" placeholder="nombre"
                    value="<?php echo $row_delete['cur_nombre'] ?>">
