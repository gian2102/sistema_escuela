...
<body>
    ...
    <div id="main-container">
        <div class="conteiner-add">
            ...
            <input type="text" class="form-control mb-3" name="nombre" placeholder="nombre" value="<?php echo $row_edit['hor_tipo'] ?>">
            <input type="time" class="form-control mb-3" name="inicio" placeholder="Hora de inicio" value="<?php echo $row_edit['hor_inicio'] ?>">
            <input type ="time" class="form-control mb-3" name="fin" placeholder="Hora de fin" value="<?php echo $row_edit['hor_fin'] ?>">
